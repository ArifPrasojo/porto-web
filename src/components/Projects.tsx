        ...
        <div className="relative group/slider">
          ...
          {filteredProjects.length > 3 && (
            <>
              <button 
                onClick={scrollLeft}
                className="absolute -left-4 md:-left-6 top-1/2 -translate-y-1/2 z-30 p-2 md:p-3 bg-[var(--color-secondary)] border-2 border-[var(--color-accent)] text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-[var(--color-accent-text)] transition-all mecha-cut-sm shadow-[0_0_15px_rgba(0,92,250,0.3)] opacity-0 group-hover/slider:opacity-100 hidden md:block"
              ...
              <button 
                onClick={scrollRight}
                className="absolute -right-4 md:-right-6 top-1/2 -translate-y-1/2 z-30 p-2 md:p-3 bg-[var(--color-secondary)] border-2 border-[var(--color-accent)] text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-[var(--color-accent-text)] transition-all mecha-cut-sm shadow-[0_0_15px_rgba(0,92,250,0.3)] opacity-0 group-hover/slider:opacity-100 hidden md:block"
            ...
            <AnimatePresence mode="popLayout">
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  className="w-[100%] shrink-0 lg:w-[calc(33.3333%-1.6666rem)] snap-start bg-[var(--color-secondary)] mecha-cut overflow-hidden mecha-border border-b-4 border-b-[var(--color-highlight)] group hover:border-[var(--color-accent)] transition-all hover:shadow-2xl relative"
          ...
          <div className="flex justify-center mt-4 md:hidden">
            <span className="text-[10px] text-[var(--color-text-muted)] font-mono flex items-center gap-2">
              <ChevronLeft size={12} /> GESER UNTUK MELIHAT <ChevronRight size={12} />
            </span>
          </div>
        </div>
      </div>
